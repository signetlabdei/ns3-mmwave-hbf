...
class MmWaveAsyncHbfMacScheduler : public MmWaveMacScheduler
{
public:
  ...
  MmWaveAsyncHbfMacScheduler ();

  virtual ~MmWaveAsyncHbfMacScheduler ();
  ...
  friend class MmWaveAsyncHbfMacSchedSapProvider;
  friend class MmWaveAsyncHbfMacCschedSapProvider;
