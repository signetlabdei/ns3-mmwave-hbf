 ...
 */
static void
DoBeamforming (Ptr<NetDevice> thisDevice, Ptr<AntennaArrayBasicModel> thisAntenna, Ptr<NetDevice> otherDevice, Ptr<AntennaArrayBasicModel> otherAntenna)
{
...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::ThreeGppChannel::UpdatePeriod", TimeValue(MilliSeconds (1))); // update the channel at each iteration
  Config::SetDefault ("ns3::ThreeGppPropagationLossModel::UpdatePeriod", TimeValue(MilliSeconds (0.0))); // do not update the shadowing
  ...
  m_spectrumLossModel->SetFrequency (frequency);
  m_spectrumLossModel->SetScenario (scenario);
  ...
  m_spectrumLossModel->SetChannelConditionModel (condModel);
  ...
  txAntenna->SetAntennaNumDim1 (2);
  txAntenna->SetAntennaNumDim2 (2);

  Ptr<AntennaArrayModel> rxAntenna = CreateObject<AntennaArrayModel> ();
  rxAntenna->SetAntennaNumDim1 (2);
  rxAntenna->SetAntennaNumDim2 (2);
